...
final readonly class Config
{
     ...
     * `actions`, `security`) merge key-by-key so a later layer adds/overrides
     * entries; everything else is replaced wholesale.
     *
    ...
    private function merge(array $base, array $override): array
    {
        foreach ($override as $key => $value) {
            ...
            } elseif ($key === 'settings' || $key === 'actions' || $key === 'security') {
